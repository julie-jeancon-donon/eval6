    ...
    <div class="row">
        <div class="col-10 col-md-6 col-lg-3 mx-auto">
            <form method="post" action="index.php" class="mt-5 bgform">
                ...
                <input type="submit" name="connect" value="Connexion" class="d-block mx-auto mb-2 w-50 p-2 deco">
            </form>

            <a class="inscriptionlink" href="inscription.php">Pas encore inscrit? C'est par ici.</a>
